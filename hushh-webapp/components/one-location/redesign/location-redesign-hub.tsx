  ...
  return (
    ...
    >
      <button
        ...
        aria-label={ariaLabel}
        className={cn(
          "grid min-h-[60px] w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 px-4 py-2.5 text-left outline-none transition-colors motion-reduce:transition-none sm:min-h-16",
